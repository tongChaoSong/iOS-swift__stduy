...
class SecondDetailVC: BaseViewController {
  ...
  extension SecondDetailVC: UICollectionViewDelegate, UICollectionViewDataSource {
  ...
  extension SecondDetailVC: WaterfallMutiSectionDelegate {
