...
@interface FNPSDWebImageCodersManager : NSObject<FNPSDWebImageCoder>
/**
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<FNPSDWebImageCoder>* coders;
