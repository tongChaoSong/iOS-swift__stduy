...
FOUNDATION_EXPORT UIImage *FNPSDScaledImageForKey(NSString *key, UIImage *image);

typedef void(^FNPSDWebImageNoParamsBlock)(void);

FOUNDATION_EXPORT NSString *const FNPSDWebImageErrorDomain;
