...
@interface FNPSDWebImageCoderHelper : NSObject
/**
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<FNPSDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<FNPSDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
